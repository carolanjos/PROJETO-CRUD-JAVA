...
import com.conexaoSQL.bean.Usuario;
...
public class UsuarioDao {
	...
	public static Connection getConnection() {
		...
		try {
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/projetofinal", "root", ""); 
		}catch (Exception e) {
	...
	//get para alterar registro do ID 
	...
	public static int consultarUsuario(Usuario u) {
		int status = 0;
